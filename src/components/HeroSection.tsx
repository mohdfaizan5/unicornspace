...
const HeroSection = () => {
  return (
    <main className="h-[90vh] flex flex-col gap-3 justify-center items-start px-5 md:items-center pb-10 relative">
      ...
      <Image src={"/binary_pngs_white/Binary_black_003.png"} alt="" width={300} height={300} className="hidden md:block absolute right-10 animate-background-shine"/>
      <Image src={"/binary_pngs_white/Binary_black_012.png"} alt="" width={300} height={300} className="animate-pulse md:animate-none absolute md:left-20 -right-20 md:bottom-16 -bottom-10 opacity-60"/>
