...
const Navbar = () => {
  return (
    <>
      <header className="fixed top-0 left-0 right-0 flex items-center justify-between max-w-screen-xl px-4 py-5 mx-auto border-b-2 border-zinc-700 bg-background ">
        ...
        <nav className="items-center hidden gap-5 text-sm md:flex font-satori-300">
          ...
          <a
            href="#"
            className="pr-4 border-r-2 hover:scale-105 hover:underline-offset-auto hover:underline"
          >
            Culture
          </a>
          <a
        ...
        <StyledButton className="flex items-center gap-1 btn-primary group">
          getStarted <ArrowDownIcon className="group-hover:translate-x-px" />
        </StyledButton>
      </header>
