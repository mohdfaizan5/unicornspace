    ...
    content: [
      {
        type: "p",
        content:
          "This landing page was created for an agency that specializes in providing cloud and data services to companies. ",
      },
      {
        type: "p",
        content:
          "It was designed with the goal of converting visitors into potential clients by providing clear information about the agency’s offerings, case studies, and an easy way for users to get in touch or request a consultation.",
      },
      {
        type: "p",
        content:
          "With a modern, minimalistic aesthetic, clear calls to action, intuitive navigation, and trust-building elements like client testimonials and certifications are strategically placed to encourage engagement and facilitate conversions. ",
      },
      {
        type: "p",
        content:
          "The page is sleek, professional, and optimized for lead generation.",
      },
      { type: "p", content: "Technologies used" },
      {
        type: "p",
        content: "React, Javascript, TailwindCSS, ShadCN, Vercel, Git... ",
      },
    ],
  },
];
